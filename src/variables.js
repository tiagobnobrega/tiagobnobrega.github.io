export default {
  ...
  about: {
    ...
    paragraphs: [
      'Tech enthusiast, javascript fan & coffee addicted. I belive you can do anything with just a screwdriver and enough will power, but you can definitely do a better job with the right tool.',
